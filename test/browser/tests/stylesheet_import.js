test('stylesheet_import.php', function (assert, document) {
    ...
    function wait() {
        ...
        assert.equal(cs.backgroundColor, 'rgb(0, 0, 255)', 'The <h1> should have a blue background');
        ...
        assert.equal(importStatements, 0, 'There should be no @import statements in any <style> elements');
    }
});
