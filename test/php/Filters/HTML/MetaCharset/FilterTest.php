...
class FilterTest extends HTMLFilterTestCase {
    ...
    public function insertRemoveCharsetData() {
        ...
        yield [
            '<!-- YOLO --><style></style><meta charset="YOLO" something=else></head><body></body></html>',
            '<!-- YOLO --><meta charset="utf-8"><style></style><meta charset="YOLO" something=else></head><body></body></html>',
        ];
    }
}
